...
AWS.NodeHttpClient = AWS.util.inherit({
  handleRequest: function handleRequest(httpRequest, httpOptions, callback, errCallback) {
    ...
    console.log("AWS.endpoint is aaa " + JSON.stringify(endpoint,0,4) + "bbb")
    if (httpOptions.proxy) {
      ...
      console.log("AWS.endpoint[proxy] is ccc" +JSON.stringify(httpOptions.proxy,0,4) + "ddd");
    }
    
      console.log("AWS.httpOptions.agent is fff" +JSON.stringify(httpOptions.agent,0,4) + "eee");
